...
@endif
<h1>Hiệu chỉnh bếp</h1>
<form method="post" action="{{ route('danhsachbep.update', ['danhsachbep' => $b->b_id]) }}" enctype="multipart/form-data">
    <input type="hidden" name="_method" value="PUT" />
    {{ csrf_field() }}
    <div class="form-group">
        <label for="b_ten">Tên bếp</label>
        <input style="width:300px;"type="text" class="form-control" id="b_ten" name="b_ten" value="{{ old('b_ten',  $b->b_ten) }}">
    </div> 
