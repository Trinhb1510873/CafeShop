...
@endif
<h1>Hiệu chỉnh loại món ăn</h1>
<form method="post" action="{{ route('danhsachloaimonan.update', ['danhsachloaimonan' => $lma->lma_id]) }}" enctype="multipart/form-data">
    <input type="hidden" name="_method" value="PUT" />
    {{ csrf_field() }}
    <div class="form-group">
        <label for="lma_ten">Tên Loại Món Ăn</label>
        <input style="width:300px;"type="text" class="form-control" id="lma_ten" name="lma_ten" value="{{ old('lma_ten',  $lma->lma_ten) }}">
    </div> 
