...
<form method="post" action="{{ route('danhsachloaimonan.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="form-group">
        <label for="lma_ten">Tên Loại Món Ăn</label>
        <input style="width:300px;"type="text" class="form-control" id="lma_ten" name="lma_ten" value="{{ old('lma_ten') }}">
    </div>
